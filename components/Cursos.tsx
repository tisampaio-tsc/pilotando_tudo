...
const oficinaCopy = {
  ...
  highlights: [
    "Costura de qualquer modelo de calça jeans",
    "Técnica profissional e acabamento de alto padrão",
    "Mercado da moda, empreender ou peças únicas",
  ],
};
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-10">
          ...
          <article className="bg-gold/10 border border-gold/30 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:border-gold/50 transition-all duration-300 flex flex-col">
            <div className="relative h-48 sm:h-56 bg-navy-800">
              <Image
            ...
            <div className="p-6 md:p-8 flex-1 flex flex-col">
              ...
              <p className="text-white/90 text-sm md:text-base mb-4 leading-relaxed flex-1">
                {oficinaCopy.description}
              </p>
              <ul className="space-y-1.5 mb-6 text-white/85 text-sm">
                {oficinaCopy.highlights.map((item) => (
              ...
              <Link
                ...
                className="inline-flex items-center justify-center w-full sm:w-auto px-6 py-3 bg-navy-900 hover:bg-navy-800 text-white font-semibold rounded-md transition-all duration-300 hover:scale-[1.02]"
              >
                Quero me inscrever
              </Link>
            </div>
          ...
          {/* Pilotando Tudo */}
          <article className="bg-gold/10 border border-gold/30 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:border-gold/50 transition-all duration-300 flex flex-col">
            <div className="relative h-48 sm:h-56 bg-navy-800 w-full overflow-hidden">
              <Image
                src={pilotandoCopy.image}
                alt={pilotandoCopy.alt}
                fill
                className="object-cover object-[center_calc(100%+40px)]"
                sizes="(max-width: 768px) 100vw, 50vw"
              />
            </div>
            <div className="p-6 md:p-8 flex-1 flex flex-col">
